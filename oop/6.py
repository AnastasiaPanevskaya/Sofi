...
# В коде описан класс Point (точка на карте),
# у него есть свойства — широта и долгота, и метод distance(self, other)
...
# координаты города (объект класса Point), его название и численность населения;

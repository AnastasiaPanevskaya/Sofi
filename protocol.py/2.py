# Почувствуй себя веб-сервером Яндекса. Tы получилa страшный URL — и чтобы ответить на запрос,
# тебе нужно сперва понять, о чём же тебя спрашивают. 
# Расшифруй, какой вопрос задал Яндексу пользователь.
